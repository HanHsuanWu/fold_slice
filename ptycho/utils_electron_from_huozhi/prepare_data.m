...
scriptfolder = 'Y:\Han-Hsuan\fold_slice\ptycho';
...
addpath(fullfile(pwd, 'utils_electron_from_huozhi'));

disp("current pwd");
disp(pwd);

% Step 2: load data
data_dir = 'Y:\Han-Hsuan\Ptychography_test\Trial1_bulk\'
%data_dir = '/mnt/pgo4/pgo4_v1/Han-Hsuan/Ptychography_test/Trial1_bulk/'; %change this
...
exp_p.nv = 360; %final dp pattern size
% exp_p.rot_ang = 20.0;
