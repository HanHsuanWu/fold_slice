...
Nlayers = 2;
reg_layers = 1;
Niter_save_results = 2;
Niter_plot_results = 2;
...
p.   scan_number = 1;                    % Multiple scan numbers for shared scans
...
output_dir_suffix = strcat('_rot_ang', num2str(rot_ang),'_engine',num2str(numel(1)));
