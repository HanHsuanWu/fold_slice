...
%   This file is called if you specify p.detector = 'ELA'.
% ** p          p structure
% returns:
...
det.mask_unwarp = true;                 % mask empty pixels from unwarp distorsion in Nion
det.data_stored = true;                % false == data are generated "onfly", no need to load / store
det.geometry.sz = [1028 512];           % detector readout size
